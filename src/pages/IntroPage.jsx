...
export default function IntroPage() {
  ...
  return (
    <>
      ...
      {/* 4) Why Choose LMS? Features Strip */}
      ...
      {/* 6) Tech Stack */}
      <Box component="section" id="tech-stack" sx={{
        maxWidth: 1200,
        mx: "auto",
        px: 2,
        py: 6,
      ...
      <Box component="footer" sx={{ bgcolor: "#f8f8f8", px: 2, py: 4 }}>
        <Box sx={{
          ...
          <Box>
            <Button href="/privacy" sx={{ color: "inherit", mr: 2 }}>Privacy Policy</Button>
            <Button href="/terms"   sx={{ color: "inherit", mr: 2 }}>Terms of Service</Button>
            <Button href="https://github.com/your-repo" sx={{ color: "inherit", mr: 2 }}>GitHub</Button>
